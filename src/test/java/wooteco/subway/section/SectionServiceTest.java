...
public class SectionServiceTest {
    ...
    void initSection() {
        ...
        sectionService.initSection(lineId, sectionRequest);

        then(sectionDao).should()
    ...
    void addSection() {
        ...
        then(sectionDao).should()
                .deleteSectionsOf(lineId);
        then(sectionDao).should()
                .saveSections(lineId, Arrays.asList(section, sectionToAdd));
    }
    ...
    void deleteSection() {
        ...
        then(sectionDao).should()
                .deleteSectionsOf(lineId);
        then(sectionDao).should()
                .saveSections(lineId, Collections.singletonList(section2));
    }
}
